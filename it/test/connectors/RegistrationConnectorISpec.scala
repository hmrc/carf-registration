...
import uk.gov.hmrc.carfregistration.models.responses.errors.*
import uk.gov.hmrc.carfregistration.models.{JsonValidationError, NotFoundError}
...
class RegistrationConnectorISpec extends ApplicationWithWiremock with ScalaFutures with IntegrationPatience {
  ...
  val testError400ResponseBody = ErrorResponse(
    errorDetail = ErrorDetail(
      timestamp = "2020-09-25T21:54:12.015Z",
      correlationId = "1ae81b45-41b4-4642-ae1c-db1126900001",
      errorCode = Some(ErrorCode("400")),
      errorMessage = Some(ErrorMessage("Invalid JSON document.")),
  ...
  val testError422ResponseBody = ErrorResponse(
    errorDetail = ErrorDetail(
      timestamp = "2020-09-28T14:31:41.286Z",
      correlationId = "ee25ef6f-79fb-41db-ac5b-f4f0301bcbee",
      errorCode = Some(ErrorCode("200")),
      errorMessage = Some(ErrorMessage("Duplicate submission")),
  ...
  val testError500ResponseBody = ErrorResponse(
    errorDetail = ErrorDetail(
      timestamp = "2020-09-28T14:31:41.286Z",
      correlationId = "d60de98c-f499-47f5-b2d6-e80966e8d19e",
      errorCode = Some(ErrorCode("5xx")),
      errorMessage = Some(ErrorMessage("<detail as generated by service>")),
      source = Some("Back End"),
      sourceFaultDetail = Some(
        SourceFaultDetail(
          detail = List(
